...
const baseBridgeValidator = { power: long_1.default.UZERO, ethereumAddress: "" };
...
exports.LastObservedEthereumBlockHeight = {
    ...
    fromJSON(object) {
        ...
        if (object.cosmosBlockHeight !== undefined &&
            ...
            message.cosmosBlockHeight = long_1.default.fromString(object.cosmosBlockHeight);
        }
        else {
        ...
        if (object.ethereumBlockHeight !== undefined &&
            ...
            message.ethereumBlockHeight = long_1.default.fromString(object.ethereumBlockHeight);
        }
        else {
    ...
    toJSON(message) {
        ...
        message.cosmosBlockHeight !== undefined &&
            (obj.cosmosBlockHeight = (message.cosmosBlockHeight || long_1.default.UZERO).toString());
        message.ethereumBlockHeight !== undefined &&
            (obj.ethereumBlockHeight = (message.ethereumBlockHeight || long_1.default.UZERO).toString());
        return obj;
    },
    fromPartial(object) {
        const message = Object.assign({}, baseLastObservedEthereumBlockHeight);
