...
exports.MsgConfirmLogicCall = {
  ...
  fromJSON(object) {
    ...
    if (
      ...
      message.invalidationNonce = long_1.default.fromString(
        object.invalidationNonce
      );
    } else {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          message.members.push(
            types_1.BridgeValidator.decode(reader, reader.uint32())
          );
          break;
        case 5:
  ...
  toJSON(message) {
    ...
    if (message.members) {
      obj.members = message.members.map(e =>
        e ? types_1.BridgeValidator.toJSON(e) : undefined
      );
    } else {
      obj.members = [];
    }
  ...
  toJSON(message) {
    ...
    message.subject !== undefined &&
      (obj.subject = message.subject
        ? any_1.Any.toJSON(message.subject)
        : undefined);
    message.signature !== undefined && (obj.signature = message.signature);
    message.sender !== undefined && (obj.sender = message.sender);
    return obj;
...
class MsgClientImpl {
  ...
  ValsetConfirm(request) {
    ...
    return promise.then(data =>
      exports.MsgValsetConfirmResponse.decode(
  ...
  SendToEth(request) {
    ...
    return promise.then(data =>
      exports.MsgSendToEthResponse.decode(new minimal_1.default.Reader(data))
    );
  }
  RequestBatch(request) {
    ...
    return promise.then(data =>
      exports.MsgRequestBatchResponse.decode(new minimal_1.default.Reader(data))
    );
  }
  ConfirmBatch(request) {
    ...
    return promise.then(data =>
      exports.MsgConfirmBatchResponse.decode(new minimal_1.default.Reader(data))
    );
  }
  ConfirmLogicCall(request) {
    ...
    return promise.then(data =>
      exports.MsgConfirmLogicCallResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
  SendToCosmosClaim(request) {
    ...
    return promise.then(data =>
      exports.MsgSendToCosmosClaimResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
  BatchSendToEthClaim(request) {
    ...
    return promise.then(data =>
      exports.MsgBatchSendToEthClaimResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
  ValsetUpdateClaim(request) {
    ...
    return promise.then(data =>
      exports.MsgValsetUpdatedClaimResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
  ERC20DeployedClaim(request) {
    ...
    return promise.then(data =>
      exports.MsgERC20DeployedClaimResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
  LogicCallExecutedClaim(request) {
    ...
    return promise.then(data =>
      exports.MsgLogicCallExecutedClaimResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
  SetOrchestratorAddress(request) {
    ...
    return promise.then(data =>
      exports.MsgSetOrchestratorAddressResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
  CancelSendToEth(request) {
    ...
    return promise.then(data =>
      exports.MsgCancelSendToEthResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
  SubmitBadSignatureEvidence(request) {
    ...
    return promise.then(data =>
      exports.MsgSubmitBadSignatureEvidenceResponse.decode(
        new minimal_1.default.Reader(data)
      )
    );
  }
